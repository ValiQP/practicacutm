...
/* ==========================================================================
   6. MODAL CONECTARE, ÎNREGISTRARE & DECONECTARE (CUSTOM)
   ========================================================================== */
...
if (loginOverlay) {
    loginBtns.forEach(btn => {
        btn.addEventListener('click', (e) => {
            ...
            if (localStorage.getItem('v_energy_user')) {
                const msg = document.getElementById('logout-message');
                if(msg) msg.innerText = "EȘTI CONECTAT CA " + localStorage.getItem('v_energy_user') + ". DOREȘTI SĂ TE DECONECTEZI?";
    ...
    if(btnCancelLogout) {
        btnCancelLogout.addEventListener('click', () => logoutOverlay.style.display = 'none');
    }

    if(btnConfirmLogout) {
        btnConfirmLogout.addEventListener('click', () => {
            localStorage.removeItem('v_energy_user');
